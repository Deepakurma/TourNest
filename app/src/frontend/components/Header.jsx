        ...
        <Link to="/">
          <img
            ...
            onError={(e) => {
              ...
              e.target.src =
                "https://raw.githubusercontent.com/jonasschmedtmann/complete-node-bootcamp/master/4-natours/after-section-12/public/img/logo-white.png";
            }}
          />
        </Link>
      </div>
      ...
      <nav className="nav nav--user">
        {authenticated ? (
          ...
          <>
            ...
            <Link
              to="/signup"
              className="nav__el btn btn--small btn--green"
              style={{ color: "white" }}
            >
              Sign up
            </Link>
