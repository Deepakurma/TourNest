  ...
  const filteredTours = useMemo(() => {
    ...
    if (searchVal && searchVal.trim() !== '') {
      ...
      result = result.filter(tour =>
        ...
        (tour.startLocation && tour.startLocation.description.toLowerCase().includes(query))
      );
    }

    // Difficulty filter
    if (selectedDifficulty !== 'all') {
      result = result.filter(tour => tour.difficulty.toLowerCase() === selectedDifficulty);
    }
      ...
      <section id="catalog" style={{ scrollMarginTop: '100px' }}>
        <div className="filter-bar">
          ...
          <div className="filter-group range-slider">
            ...
            />
            <span style={{ fontWeight: '700', color: 'var(--color-primary-light)', minWidth: '60px' }}>
              ${maxPrice}
            </span>
          </div>
          ...
          <div className="filter-group">
            ...
            <select
              ...
              style={{ background: '#111827', color: 'white', border: '1px solid var(--color-border)' }}
            >
        ...
        {filteredTours.length > 0 ? (
          ...
          <div style={{
            ...
            <h3 style={{ fontSize: '1.5rem', fontWeight: '600', marginBottom: '0.5rem' }}>No adventures match your criteria</h3>
